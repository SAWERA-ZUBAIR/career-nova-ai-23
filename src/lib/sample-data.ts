...
export const OPPORTUNITIES: Opportunity[] = [
  ...
  mk({ id: "r2", type: "remote", title: "Growth Marketer", organization: "Loop", logo: "🔁", location: "Remote (EU)", meta: "$70k–$95k", category: "Marketing", tags: ["Growth", "Full-time"], deadline: "2026-08-30", remote: true, applyUrl: "https://weworkremotely.com/categories/remote-marketing-jobs", description: "Own growth channels for a fast-growing B2B SaaS." }),

  // Fellowships
  mk({ id: "f1", type: "fellowship", title: "Mozilla Open Source Fellowship", organization: "Mozilla", logo: "🦊", location: "Remote", meta: "10 months", category: "Tech", tags: ["Paid", "Fellowship"], deadline: "2026-09-30", officialSource: true, applyUrl: "https://foundation.mozilla.org/en/what-we-fund/awards/", description: "Fund open-source contributions that benefit the internet." }),
  mk({ id: "f2", type: "fellowship", title: "Acumen Fellowship", organization: "Acumen", logo: "🌱", location: "Global", meta: "1 year", category: "Impact", tags: ["Leadership"], deadline: "2026-10-01", officialSource: true, applyUrl: "https://acumenacademy.org/fellowship", description: "Leadership program for social change makers." }),

  // Competitions
  mk({ id: "c1", type: "competition", title: "Google Coding Competitions", organization: "Google", logo: "🧠", location: "Online", meta: "Team-based", category: "Coding", tags: ["Prize"], deadline: "2026-04-15", officialSource: true, applyUrl: "https://codingcompetitions.withgoogle.com/", description: "Solve engineering problems with a team." }),
  mk({ id: "c2", type: "competition", title: "Hult Prize", organization: "Hult", logo: "🏅", location: "Global", meta: "USD 1M prize", category: "Startup", tags: ["Prize"], deadline: "2026-09-15", officialSource: true, applyUrl: "https://www.hultprize.org/", description: "World's largest student startup competition." }),

  // Conferences
  mk({ id: "co1", type: "conference", title: "React Summit", organization: "GitNation", logo: "⚛️", location: "Amsterdam, NL", meta: "3 days", category: "Engineering", tags: ["Tech"], deadline: "2026-05-01", officialSource: true, applyUrl: "https://reactsummit.com/", description: "The biggest React conference in the world." }),
  mk({ id: "co2", type: "conference", title: "Web Summit", organization: "Web Summit", logo: "🌐", location: "Lisbon, PT", meta: "4 days", category: "Tech", tags: ["Networking"], deadline: "2026-10-01", officialSource: true, applyUrl: "https://websummit.com/", description: "Where the tech world meets." }),

  // Exchange
  mk({ id: "e1", type: "exchange", title: "Erasmus+ Exchange", organization: "European Commission", logo: "🎒", location: "EU", meta: "1–2 semesters", category: "Study Abroad", tags: ["Grant"], deadline: "2026-03-01", officialSource: true, applyUrl: "https://erasmus-plus.ec.europa.eu/opportunities/individuals/students", description: "Study a semester in another European university." }),
  mk({ id: "e2", type: "exchange", title: "AIESEC Global Volunteer", organization: "AIESEC", logo: "🤝", location: "Global", meta: "6–8 weeks", category: "Volunteering", tags: ["Cultural"], deadline: "2026-06-01", officialSource: true, applyUrl: "https://aiesec.org/global-volunteer", description: "Volunteer abroad on SDG-linked projects." }),

  // Graduate
  mk({ id: "g1", type: "graduate", title: "Unilever Future Leaders Program", organization: "Unilever", logo: "🌿", location: "Global", meta: "3 years", category: "Business", tags: ["Graduate"], deadline: "2026-11-30", officialSource: true, applyUrl: "https://careers.unilever.com/uflp", description: "Fast-track graduate leadership program." }),
  mk({ id: "g2", type: "graduate", title: "McKinsey Business Analyst", organization: "McKinsey & Company", logo: "📈", location: "Global", meta: "2 years", category: "Consulting", tags: ["Graduate"], deadline: "2026-09-15", officialSource: true, applyUrl: "https://www.mckinsey.com/careers/search-jobs", description: "Solve the toughest problems for the world's leading organizations." }),

  // Bootcamps
  mk({ id: "b1", type: "bootcamp", title: "Le Wagon Web Development", organization: "Le Wagon", logo: "🚂", location: "Global / Online", meta: "9 or 24 weeks", category: "Tech", tags: ["Coding"], deadline: "2026-09-01", officialSource: true, applyUrl: "https://www.lewagon.com/apply", description: "Learn to build web apps and change your career." }),
  mk({ id: "b2", type: "bootcamp", title: "ALX Software Engineering", organization: "ALX Africa", logo: "🌍", location: "Africa / Online", meta: "12 months", category: "Tech", tags: ["Free"], deadline: "2026-08-15", officialSource: true, applyUrl: "https://www.alxafrica.com/programmes/", description: "Full-time software engineering program for African tech talent." }),
];
